...
- 피타고라스 정리 a<sup>2</sup>+b<sup>2</sup> = c<sup>2</sup> 에서 가져옴
...
(2) 마이너스 radius 하는 이유; 원의 중심을 클릭 위치에 맞추기 위함 ->  left를 원의 중심위치가 아닌, 원의 왼쪽 끝 위치를 의미하기 때문. 원의 중심이 클릭 위치보다 오른쪽으로 밀리게 될 때 원의 왼쪽 끝을 클릭 위치보다 반지름 만큼만 왼쪽으로 옮겨줘야 함
